...
int main(int argc, char* argv[])
{
	...
	const std::string sourceV = "#version 330 core\n"
		...
		"\n"
		"}\n";
	//refractaion will be coded in the fragment shader
	const std::string sourceF = "#version 400 core\n"
		...
		"void main() { \n"
		//What do you need to compute the refraction vector R ?
		
		//Find the position you need to sample on the cubemap, tips : glsl has a refract method
		"//vec3 R = ...; \n"
	...
	Diamond:  2.42
*/
	//You can send a refraction indice to the shader if you want to modify the appearence of the object
